...
if "squat_workouts" not in st.session_state:
    st.session_state.squat_workouts = []
...
if not st.session_state.training_mode:
    ...
    if st.session_state.squat_workouts:
        # Pandas Tabelle mit letzten Trainings
        df = pd.DataFrame(st.session_state.squat_workouts)
    ...
    suggested_weight = get_suggested_weight("Barbell Squat", data_df)
