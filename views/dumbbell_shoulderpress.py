...
st.markdown("""
Dumbbell Shoulder Press ist eine ideale Übung für die Entwicklung von Schulter- und Armmuskulatur.

**Muskeln:**
- Schultern (Deltamuskeln) - Hauptmuskel
- Trizeps
- Oberbrust
""")
...
if not st.session_state.training_mode:
    ...
    with col1:
        if st.button("✅ Speichern", use_container_width=True):
            ...
            st.session_state.shoulderpress_workouts.append(workout)
